...
[![GoDoc](https://godoc.org/github.com/ad3n/cache?status.svg)](https://pkg.go.dev/github.com/ad3n/cache/v9?tab=doc)
...
```shell
go get github.com/ad3n/cache/v9
```
